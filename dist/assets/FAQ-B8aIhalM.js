import{r as s,g as i,j as e,c as o,S as h}from"./index-BT_7v_Bk.js";i.registerPlugin(h);const f=o.section`
    position: relative;
    padding: 60px 20px;
    background: #ffffff;
    color: #111111;
...
`,k=o.div`
    ...
    backdrop-filter: blur(20px);
    border: 1px solid ${t=>t.$isOpen?"rgba(255, 68, 0, 0.2)":"rgba(0, 0, 0, 0.04)"};
    border-radius: 20px;
    overflow: hidden;
    transition: all 0.4s cubic-bezier(0.25, 0.8, 0.25, 1);
    box-shadow: ${t=>t.$isOpen?"0 20px 40px -10px rgba(255, 68, 0, 0.15), 0 0 0 1px rgba(255, 68, 0, 0.1)":"0 4px 6px -1px rgba(0,0,0,0.02)"};
...
`,S=o.div`
    ...
    height: 36px;
    border-radius: 50%;
    background: ${t=>t.$isOpen?"#ff4400":"#f8f9fa"};
    color: ${t=>t.$isOpen?"#fff":"#111111"};
    display: flex;
    align-items: center;
